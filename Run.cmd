...
echo [1/4] Building and testing the Kernel...
...
echo [2/4] Exporting the Godot 4.7.2 standalone game...
...
echo [3/4] Publishing the standalone Kernel host...
dotnet publish "%AUTOMAPOLIS_ROOT%src\Automapolis.Kernel.Host\Automapolis.Kernel.Host.csproj" --configuration Release --no-build --output "%AUTOMAPOLIS_ROOT%Shells\Godot\build\KernelHost"
if errorlevel 1 goto :failed

echo [4/4] Launching Automapolis...
